<?php
    ...
    $sql="UPDATE agent set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,Phonenumber=:mobileno where id=:eid";
   ...
   // $query->bindParam(':country',$country,PDO::PARAM_STR);
    ...
    $msg="fiche employees mise a jour avec succes";
    }
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Update  Section</h4>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Veuillez apporter des modifications sur le formulaire ci-dessous afin de mettre à jour votre profil</p>

                                        <?php 
                                            $eid=intval($_GET['idagent']);
                                            $sql = "SELECT * from  agent where id=:eid";
                                            $query = $dbh -> prepare($sql);
                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                            $query->execute();
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="empcode" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->idagent);?>" id="example-text-input">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">NOM</label>
                                            <input class="form-control" name="FirstName" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->FirstName);?>" id="example-text-input">
                                        </div>
