<?php
    ...
    if(isset($_POST['update'])){
        ...
        $type=$_POST['type'];   
        $sql="UPDATE rapport set lib=:lib,incident=:incident,type=:type where id=:did";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">voir</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="department.php">rapport</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <a href="rapport.php" ><p class="btn btn-primary"  >fermer</p></a>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <?php 
                                            $did=intval($_GET['rapid']);
                                            $sql = "SELECT * from rapport WHERE id=:did";
                                            $query = $dbh -> prepare($sql);
                                            $query->bindParam(':did',$did,PDO::PARAM_STR);
                                            $query->execute();
