...
<!-- imprimer  -->
<a href="voiture.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" style="padding-left: 555px;" > <br><br>
                                        <table class="table table-bordered table-hover text-left" >
                                            ...
                                            <?php 
                                            $idv=intval($_GET['idv']);
                                            $sql = "SELECT * from voiture where idv=:idv ";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            {         
                                              ...
                                              <b> Chassis :</b>
                                              <?php echo htmlentities($result->ref);?>
<br>
                                            <b> Marque </b>

                                             <?php echo htmlentities($result->marque);?>
<br>
                                          <b>  Serie : </b>

                                             <?php echo htmlentities($result->serie);?>

<br>
                                            <b>  Plaque : </b>

                                              <?php echo htmlentities($result->plaq);?>
