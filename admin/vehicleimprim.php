...
<!-- imprimer  -->
<a href="vehicle.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" style="padding-left: 555px;" > <br><br>
                                        <table class="table table-bordered table-hover text-left" >
                                            ...
                                            <?php 
                                            $idvehicle=intval($_GET['idvehicle']);
                                            $sql = "SELECT * from vehicle where idvehicle=:idvehicle ";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            {         
                                              ...
                                              <b> date :</b>
                                              <?php echo htmlentities($result->datee);?>
<br>
                                            <b> task </b>

                                             <?php echo htmlentities($result->task);?>
<br>
                                          <b>   responsible person : </b>

                                             <?php echo htmlentities($result->res);?>
