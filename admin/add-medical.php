<?php
    ...
    $sql="INSERT INTO medical (nom,datnais,site,dvisite) VALUES(:nom,:datnais,:site,:dvisite)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':nom',$nom,PDO::PARAM_STR);
    $query->bindParam(':datnais',$datnais,PDO::PARAM_STR);
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Gestion formulaire d'inspection </h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="lieu.php">Programme formulaire d'inspection</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST" >
                                 <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label"> date naissance </label>
                                            <input class="form-control" name="datnais" type="text" autocomplete="off" required id="example-text-input" >
                                        </div>
...
Programme-info </label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label"> signature</label> 
                                            <input type="text" name="nam" class="form-control" 
                                               value="
<?php $username=$_SESSION['alogin'];
    ...
    {    ?>
        ...
        <?php echo htmlentities($result->poste); ?>
