...
<!-- imprimer  -->
<a href="lieu.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" style="padding-left: 555px;" > <br><br>
                                        <table class="table table-bordered table-hover text-left" >
                                            ...
                                            {         
                                              ...
                                              <b> date :</b>
                                              <?php echo htmlentities($result->dat);?>
<br>
                                            <b> heure </b>

                                             <?php echo htmlentities($result->eur);?>
<br>
                                          <b>   responsible person : </b>

                                             <?php echo htmlentities($result->person);?>

<br>
                                            <b>  date creation : </b>

                                              <?php echo htmlentities($result->CreationDate);?></td>
