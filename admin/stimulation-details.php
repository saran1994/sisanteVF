<?php
    ...
    $remarkdate=date('d-m-y G:i:s ', strtotime("now"));
    $sql="UPDATE program set isread=:isread where idp=:did";
    ...
    $sql="UPDATE program set remark=:objectif,status=:status,remarkdate=:remarkdate where idp=:did";
    $query = $dbh->prepare($sql);
    $query->bindParam(':objectif',$objectif,PDO::PARAM_STR);
    
    
    $query->bindParam(':status',$status,PDO::PARAM_STR);
    $query->bindParam(':remarkdate',$remarkdate,PDO::PARAM_STR);
    $query->bindParam(':did',$did,PDO::PARAM_STR);
    $query->execute();
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Details simulation</span></li>
                            </ul>
                        </div>
                    </div>
...
<!-- imprimer  -->
<a href="stimulation-history.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" > 
                                        <table class="table table-bordered table-hover text-left" >
                                            ...
                                            <?php 
                                            $lid=intval($_GET['idp']);
                                            $sql = "SELECT program.idp as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.EmailId,program.datep,program.tim,program.location,program.objectif,program.scenario,program.department,program.why,program.done,program.hod,program.isread,program.status,program.creationdate,program.remark,program.remarkdate from program join tblemployees on program.empid=tblemployees.id where program.idp=:lid";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            {         
                                                ...
                                                <tr>
                                                <td ><B> P00<?php echo htmlentities($result->lid);?></B></td>
                                                <td ><b>objectif:</b></td>
                                              <td colspan="1"><?php echo htmlentities($result->objectif);?></td>
...
<td> <b> scenario:</b></td>
                                            ...
                                            <td ><b>location:</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->location);?></td>
                                            <td ><b>done or not:</b></td>
                                            <td colspan="1"><?php echo htmlentities($result->done);?></td>
                                            <td> <b> why not done:</b></td>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <p><textarea id="textarea1"  class="form-control" name="objectif" placeholder="description" row="5" maxlength="500" required></textarea></p>
