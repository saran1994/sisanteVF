<?php
    ...
    $sql="INSERT INTO injur (inci,srcei,insa,typee,acte,factore,respe,jobe,rat,seve,department,body) VALUES(:inci,:srcei,:insa,:typee,:acte,:factore,:respe,:jobe,:rat,:seve,:department,:body)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':inci',$inci,PDO::PARAM_STR);
    $query->bindParam(':body',$body,PDO::PARAM_STR);
    $query->bindParam(':srcei',$srcei,PDO::PARAM_STR);
     $query->bindParam(':department',$department,PDO::PARAM_STR);
    $query->bindParam(':insa',$insa,PDO::PARAM_STR);
    $query->bindParam(':typee',$typee,PDO::PARAM_STR);
    $query->bindParam(':acte',$acte,PDO::PARAM_STR);
    $query->bindParam(':factore',$factore,PDO::PARAM_STR);
    $query->bindParam(':jobe',$jobe,PDO::PARAM_STR);
    $query->bindParam(':respe',$respe,PDO::PARAM_STR);
    $query->bindParam(':rat',$rat,PDO::PARAM_STR);
    $query->bindParam(':seve',$seve,PDO::PARAM_STR);
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="injur.php"><img src="logo.png" alt="logo">SI-SANTE</a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Gestion rapport injurie </h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="injur.php">rapport of injurie</a></li>
...
<select class="custom-select" name="respe" autocomplete="off">
...
<select class="custom-select" name="inci" autocomplete="off">
                                <option value="">Choisir..</option>
...
<div class="form-group" style="float: left;">
                                            <label for="example-text-input" class="col-form-label">PART OF BODY </label>
<select class="custom-select" name="body" autocomplete="off">
                                <option value="">Choisir..</option>
...
<br><br><br><br><br>
                                        ...
                                        <div class="form-group" style="float: left;">
                                            <label for="example-text-input" class="col-form-label">TYPE OF INJURIE</label>
                                            <select class="custom-select" name="typee" autocomplete="off">
                                        <option value="">Choisir..</option>
                                        <option value="caught between">caught between</option>
                                        <option value="fell to below">fell to below</option>
                                        <option value="Other">Other</option>
                                        ...
                                        <div class="form-group" style="float: left;">
                                            <label for="example-text-input" class="col-form-label">SOURCE OF INJURIE </label>
<select class="custom-select" name="srcei" autocomplete="off">
                                <option value="">Choisir..</option>
...
<select class="custom-select" name="insa" autocomplete="off">
                                <option value="">Choisir..</option>
...
<select class="custom-select" name="acte" autocomplete="off">
                                <option value="">Choisir..</option>
...
<select class="custom-select" name="factore" autocomplete="off">
                                <option value="">Choisir..</option>
...
<select class="custom-select" name="jobe" autocomplete="off">
                                <option value="">Choisir..</option>
...
<select class="custom-select" name="rat" autocomplete="off">
                                <option value="">Choisir..</option>
...
<select class="custom-select" name="seve" autocomplete="off">
                                <option value="">Choisir..</option>
