<?php
    ...
    $sql="INSERT INTO admin(fullname,email,Password,UserName,department,poste) VALUES(:fullname,:email,:password,:username,:department,:poste)";
    ...
    if($lastInsertId){
    $msg="bravo!! un administrateur a ete ajouter avec succes";
    } else {
    $error="ERROR";
    }
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Ajouter admin</h4>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire afin d'ajouter un nouvel administrateur système</p>
                                    

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Nom/prenom</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="poste" autocomplete="off">
                                        <option value="">Choisir..</option>
