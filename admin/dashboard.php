                            ...
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Type incident</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/leavetype-counter.php'?></h1>
                                        <span>Type incident</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0"> utilisateurs</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/emp-counter.php'?></h1>
                                        <span>utilisateur permanent</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0"> Departements</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Fiche en attente </h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h6>incident : <?php include 'counters/pendingapp-counter.php'?></h6>
                                        <h6>simulation : <?php include 'counters/encourscount.php'?></h6>
                                        <h6>formulaire : <?php include 'counters/pendingappc.php'?></h6>
                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Total Rejet </h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                       
                                        <h6>incident : <?php include 'counters/declineapp-counter.php'?></h6>
                                        <h6>simulation : <?php include 'counters/rejetcount.php'?></h6>
                                        
                                        <h6>formulaire : <?php include 'counters/rejetcounte.php'?></h6>
                                        <span>Rejeter</span>
                                    </div>
                                </div>
                                <!-- <canvas id="coin_sales2" height="100"></canvas> -->
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Approuver</h4>
                                        
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h6>incident : <?php include 'counters/approvedapp-counter.php'?></h6>
                                        <h6>simulation : <?php include 'counters/acceptcount.php'?></h6>
                                    

                                        <h6>formulaire : <?php include 'counters/acceptcounte.php'?></h6>
                                        <span>Approuver</span>
                                    </div>
                                </div>
                                <!-- <canvas id="coin_sales3" height="100"></canvas> -->
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="trd-history-tabs">
                                        <ul class="nav" role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="dashboard.php" role="tab"> Liste Recent</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <select class="custome-select border-0 pr-3">
                                        <option selected>Dernières 24 heures</option>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="employeeLeave-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="btn btn-secondary btn-sm">Details</a></td>
                                            </tr>
                                                <?php $cnt++;} }?>
                                            </tbody>
                                                </table>
