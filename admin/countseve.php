...
<tr> <td class="td">Minor</td> 
    ...
    $sql = "SELECT idinjur from injur where  seve = 'Minor' ";
...
<tr> <td class="td">serious</td> 
    ...
    $sql = "SELECT idinjur from injur where  seve = 'serious' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Major</td> 
    ...
    $sql = "SELECT idinjur from injur where  seve = 'Major' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">#NOM?</td> 
    ...
    $sql = "SELECT idinjur from injur where  seve = '#NOM?' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
