<?php
    ...
    $sql="UPDATE tblleaves set AdminRemark=:description,AdminRemarkDate=:admremarkdate where id=:did";
    $query = $dbh->prepare($sql);
...
<a href="leave-history.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" > 
                            ...
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">Completer la fiche alerteP1</button>
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br>
                                    <p><textarea id="textarea1" name="description" class="form-control" name="description" placeholder="" row="5" maxlength="500" required></textarea></p>
                                </div>
