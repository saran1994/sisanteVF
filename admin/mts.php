<?php
    ...
    {
    $idp=$_GET['del'];
    $sql = "DELETE from  mts  WHERE idmts=:idmts";
    $query = $dbh->prepare($sql);
    $query -> bindParam(':idmts',$idmts, PDO::PARAM_STR);
    $query -> execute();
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="mts.php"><img src="logo.png" alt="logo">SI-SANTE</a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">gestion des mts </h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">Accueil</a></li>
                                <li><span>Gestion des mts </span></li>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-mts.php" class="btn btn-sm btn-info">Ajouter </a></center><br>
