...
<tr> <td class="td">Mining</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Mining' ";
...
<tr> <td class="td">Metallurgy</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Metallurgy' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Community</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Community' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Environment</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Environment' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Clinic</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Clinic' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Finance</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Finance' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Administration</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Administration' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Laboratory</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Laboratory' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Human Resources</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Human Resources' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
...
<tr> <td class="td">Exploration</td> 
    ...
    $sql = "SELECT idinjur from injur where  department = 'Exploration' ";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
