<?php
   ...
   $empid=$_SESSION['eid'];
    ...
    $sql="INSERT INTO medical (nom,datnais,site,dvisite,isread,status,empid) VALUES(:nom,:datnais,:site,:dvisite,:isread,:status,:empid)";
    ...
    if($lastInsertId){
    $msg="bravo!! utilisateur a ete ajouter avec succes";
    } else {
    $error="ERROR";
    }
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="employee.php"><img src="logo.png" alt="logo">SI-SANTE</a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Ajouter utilisateur </h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">Utilisateur</a></li>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="empcode" type="text"  required id="empcode" onBlur="checkAvailabilityEmpid()">
                                        </div>
