<?php
    ...
    if($lastInsertId){
    $msg="Department Cree avec succes!!";
    } else {
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="department.php"><img src="logo.png" alt="logo">SI-SANTE</a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Gestion Departement </h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="department.php">Departement</a></li>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Departement </label>
