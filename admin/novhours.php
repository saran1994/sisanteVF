...
<tr > <td class="corps" >Mining</td>
     ...
     <td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'  ";
                                        $query = $dbh -> prepare($sql);
     ...
     <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'  ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
                    ...
                    <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Mining' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> 
    ...
    <td class="corps">
     ...
     <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '$from_date' AND  '$to_date'   ";
                    ...
                    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '$from_date' AND  '$to_date'  ";
                         ...
                         <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Metallurgy' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Engineering</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'  ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Engineering' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Procurement</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Procurement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Procurement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Procurement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
       ...
       <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Procurement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Procurement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps">
     ...
     <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Security' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Community</td> 
     ...
     <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
            ...
            <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Community' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps">
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
     ...
     <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Environnement' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Clinic</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
   ...
   <td class="corps"><?php  
          ...
          <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Clinic' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Finance</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-31' ";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Finance' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Administration</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Administration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Laboratory</td> 
     ...
     <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Laboratory' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Human Resources</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
 ...
 <td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Human Resources' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<tr> <td class="corps">Exploration</td> 
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(emp) AS SOMME from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
          $sql = "SELECT *,SUM(tim) AS SOMME from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
    ...
    <td class="corps"><?php  
          $sql = "SELECT *,SUM(lost) AS SOMME from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30'";
                                        $query = $dbh -> prepare($sql);
       ...
       <td class="corps"><?php  
          $sql = "SELECT *,SUM(ltif) AS SOMME, SUM(emp) AS SOM from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
...
<td class="corps"><?php  
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(medical) AS SOMME from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(first) AS SOMME from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
        ...
        <td class="corps"><?php  
          $sql = "SELECT *,SUM(cost) AS SOMME from hours where  department = 'Exploration' AND dat BETWEEN '2023-01-01' AND  '2023-11-30' ";
                                        $query = $dbh -> prepare($sql);
