<?php
    ...
    $sql="INSERT INTO program (datep,tim,scenario,location,objectif,department,why,done,hod) VALUES(:datep,:tim,:scenario,:location,:objectif,:department,:hod,:done,:why)";
                                 ...
                                 <div class="card-body">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="hod" type="text" autocomplete="off" required id="example-text-input" >
