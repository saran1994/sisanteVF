<?php
    ...
    if($lastInsertId){
    $msg="type incident ajouter avec succes!!";
    } else {
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Fiche incident</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="leave-section.php">Gestion incident</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire afin d'ajouter un  incident</p>
