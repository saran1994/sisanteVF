<?php
    ...
    $sql="INSERT INTO agent(idagent,FirstName,LastName,EmailId,Gender,Dob,Department,Address,Phonenumber,Status,poste) VALUES(:idagent,:fname,:lname,:email,:gender,:dob,:department,:address,:mobileno,:status,:poste)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':idagent',$idagent,PDO::PARAM_STR);
   ...
   // $query->bindParam(':password',$password,PDO::PARAM_STR);
    ...
    if($lastInsertId){
    $msg="bravo !! Employee ajouter avec succes";
    } else {
    $error="ERROR";
    }
...
-->
    <script>
        function checkAvailabilityEmpid() {
            ...
            $("#idagent-availability").html(data);
            $("#loaderIcon").hide();
            },
            error:function (){}
            });
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="agent.php"><img src="logo.png" alt="logo">SI-SANTE</a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Ajouter Employee </h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="agent.php">Employees</a></li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="logout.php">Deconexion</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire ci-apres</p>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Mle-employees </label>
                                            <input class="form-control" name="empcode" type="text" autocomplete="off" required id="empcode" onBlur="checkAvailabilityidagent()">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Poste occupé</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Date naissance</label>
                                            <input class="form-control" type="date" name="dob" id="dob" >
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Contact</label>
...
-->
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">zone de travail</label>
...
-->
                                        ...
                                        <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return valid();">enregistrer</button>
