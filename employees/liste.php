                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Gestion incident</span></li>
                                 ...
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="single-table" id="sectionAimprimer">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.info,tblleaves.LeaveType,tblleaves.actuel,tblleaves.pot,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id  
                                        ...
                                        <tr>
                                           ...
                                           <td><?php echo htmlentities($result->actuel);?></td>

                                           <td><?php echo htmlentities($result->pot);?></td>
                                            ...
                                            if($stats==1){
                                             ?>
                                                 <span style="color: green">Terminé <i class="fa fa-check-square-o"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">Terminé partiellement <i class="fa fa-times"></i></span>
                                                 <?php } if($stats==0)  { ?>
                                            <span style="color: blue">En cours <i class="fa fa-spinner"></i></span>
                                            <?php } ?>
                                        ...
                                        <div class="single-table" id="sectionAimprimer">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT program.idp as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,program.objectif,program.status from program join tblemployees on program.empid=tblemployees.id  
...
<div class="single-table" id="sectionAimprimer">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT formul.idformul as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,formul.dril,formul.status from formul join tblemployees on formul.empid=tblemployees.id  
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->EmpId);?></td>
                                            <td><a href="update-employee.php?empid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?></a></td>
                                            <td><?php echo htmlentities($result->dril);?></td>
