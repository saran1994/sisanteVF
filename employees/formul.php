                            ...
                            <div class="card-body">
                                ...
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                  ...
                                  <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Gestion formulaire de simulation </h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="proram.php">formulaire de simulation</a></li>
                                ...
                                <center><a href="add-formul.php" class="btn btn-sm btn-info">Ajouter </a>
                        ...
                        <form action="" method="GET">
                            <div class="row">
                                    ...
                                    if(isset($_GET['from_date']) && isset($_GET['to_date'])   )
                                {
                                    ...
                                    $eid=$_SESSION['eid'];
                                    $sql = "SELECT * from formul where empid=:eid AND CreationDate BETWEEN '$from_date' AND  '$to_date'";
                                    $query = $dbh -> prepare($sql);
                                           ...
                                           ?>
                                            ...
                                            <td> <?php $stats=$result->status;
                                             ...
                                             ?>
                                                ...
                                                <a href="edit-formul.php?lid=<?php echo htmlentities($result->idformul);?>"><p class="btn btn-success">Détails</p></a>
                                             ...
                                             <td>
<!-- imprimer  -->
<a href="formul.php?idformul=<?php echo htmlentities($result->idformul);?>" >voir</i> </a>
                                            </td>
                                        </tr>
                                         <?php $cnt++;} }
