...
<!-- imprimer  -->
<a href="formul.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" style="padding-left: 555px;" > <br><br>
                                        <table class="table table-bordered table-hover text-left" >
                                            ...
                                            <?php 
                                            $idformul=intval($_GET['idformul']);
                                            $sql = "SELECT * from formul where idformul=:idformul ";
                                            ...
                                            {         
                                              ...
                                              <b> date :</b>
                                              <?php echo htmlentities($result->dril);?>
<br>
