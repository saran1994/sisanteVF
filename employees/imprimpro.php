...
<!-- imprimer  -->
<a href="program.php" onClick="imprimer('sectionAimprimer')" class="btn btn-success"><i class="fa fa-print">IMPRIMER</i> </a>
                    ...
                    <img src="logo.png" style="padding-left: 255px;" > <br><br><br>
                                        <table class="table table-bordered table-hover text-center" >
                                            ...
                                            <?php 
                                            $idp=intval($_GET['idp']);
                                            $sql = "SELECT * from program where idp=:idp ";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            {         
                                                ...
                                                <b>POO<?php echo htmlentities($result->idp);?></b>
<br>
                                              <b> date :</b>
                                              <?php echo htmlentities($result->datep);?>
<br>
                                            <b> heure </b>

                                             <?php echo htmlentities($result->tim);?>
<br>
                                          <b>departement : </b>
...
<br>
                                            <b> scenarios : </b>
                                              ...
                                              <?php echo htmlentities($result->scenario);?>
<br>
                                            <b> location : </b>
...
<br>
                                            <b> objectif : </b>
                                              ...
                                              <?php echo htmlentities($result->objectif);?>
                                              <br>
                                            <b> done or not : </b>

                                              <?php echo htmlentities($result->done);?>
                                              <br>
                                            <b> why not done : </b>
...
<br>
                                            <b> hod name : </b>
                                              ...
                                              <?php echo htmlentities($result->hod);?>
