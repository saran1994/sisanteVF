    ...
    if(isset($_POST['signin']))
    {
            ...
            if($status==0)
        {
            ...
            echo "<script type='text/javascript'> document.location = 'employees/leave.php'; </script>";
                ...
                echo "<script>alert('desole, login invalide.');</script>";
                }
            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    ...
                    <a href="#"><img src="logo.png" alt="logo">SI-SANTE</a>
                        ...
                        <?php if($msg){?><div class="errorWrap"><strong>Erreurr</strong> : <?php echo htmlentities($msg); ?> </div><?php }?>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="password-recovery.php"> Password oublier?</a>
                            </div>
                        </div>
                        ...
                        <div class="form-footer text-center mt-5">
                            <p class="text-muted"><a href="admin/index.php">compte Administrateur</a></p>
                        </div>
                    </div>
                </form>
            </div>
